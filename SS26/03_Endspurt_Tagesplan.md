# 🏁 Endspurt-Plan · Do 02.07 – Mi 08.07 (Klausur: Do 09.07)

> **Erstellt Do 02.07.2026.** Ersetzt die offenen Tage des `[02_Tagesplan.md](./02_Tagesplan.md)`
> (Stand: alles bis #5 Bayes ✅, offen: #6 ZV + kompletter KRYPTO-Block + Generalprobe).
> **Nichts wird gestrichen** — alle Pakete des Original-Plans bleiben drin, es wird
> stattdessen **täglich mehr Zeit investiert**: ~**3 h/Tag** statt 60–90 min (gesamt ~21 h in 7 Tagen).

**Prinzip pro Tag:** 🟦 Verstehen (Lernkarte durcharbeiten) und 🟧 Drillen (echte Klausuraufgaben
selbst rechnen, mit `Loesungen/` kontrollieren) am **selben Tag** — der Stoff bleibt frisch,
weil zwischen Verstehen und Anwenden keine Nacht mehr liegt.
...
**Taktik** (aus `[00_Strategie](./00_Strategie_WuK.md)` §4): Tier 1 zuerst (#1 → #2 → #9 → #4 → #5), dann Tier 2 (#7 → #3 → #8), #6 nur mit Restzeit.
**Formel immer hinschreiben** (Teilpunkte) · Gegenereignis-Reflex · „(mod …)" notieren · letzte 15 min Kontrolle (v.a. Modulo-Rechnungen & Brüche).

---

## Warum das aufgeht

- **Alle Pakete des Original-Plans sind enthalten** — auch beide Probeklausuren, die optionale dritte, alle Übungssets und alle Spicker-Übertragungen. Verdichtet wurde nur der Kalender, nicht der Stoff.
- **KRYPTO bekommt 4 volle Tage (Fr–Mo)** — der größte Hebel (~30–40 Pkt aus einem Werkzeugkasten) bleibt die wichtigste Phase.
- **Verstehen + Drillen am selben Tag** spart die Wiederanlauf-Zeit, die der alte 2-Tage-Rhythmus gekostet hätte.
...
- [ ] #9 RSA (05.07)
- [ ] #8 Affine (06.07) · Spicker ⑧⑨
- [ ] 🧪 SoSe20 ≥ 50 % (06.07 abends)
- [ ] 🧪 21SoSe ≥ 60 % (07.07)
- [ ] A4-Spicker fertig & verinnerlicht (08.07)